...
/**
 * MovieInfoPageComponent displays detailed information about a movie.
 * It uses the movieId in the URL parameters to fetch the movie data.
 *
 * @property {Movie} movie - The movie to display.
 * @property {Observable<FavouriteIcon>} favouriteIcon$ - An observable holding the information
 * about whether the movie is favourited or not.
 *
 * @see ActivatedRoute
 * @see MatDialog
